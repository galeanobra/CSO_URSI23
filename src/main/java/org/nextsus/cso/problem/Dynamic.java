...
//            udn.updateUsersPositionFromMatrix(interval);
      ...
      if (udn.getMobilityType().equalsIgnoreCase("randomWaypoint")
          || (udn.getMobilityType().equalsIgnoreCase("shanghai") && udn.updateUsersPositionShanghai(
          i))
          || (udn.getMobilityType().equalsIgnoreCase("matrix") && udn.updateUsersPositionFromMatrix(
          i))) {
