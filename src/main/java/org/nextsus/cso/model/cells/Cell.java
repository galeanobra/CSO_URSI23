...
public abstract class Cell {
    ...
    public double getTrafficDemand() {
        ...
        for (User u : this.udn_.getUsers()) {
            if (u.getServingCell() == this) {
                ...
                // If it is not satisfied, the upper bound is the capacity of the link
    ...
    public double getAttenuationFactor(int azi, int occi) {
        ...
        if (azi + this.angleShift_ > 360) azi = azi + this.angleShift_ - 360;
        else azi = azi + this.angleShift_;
