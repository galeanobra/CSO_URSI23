...
public class Sector {
    ...
    Sector(int x, int y, int z, UDN udn, BTS bts, String antennaType, String antennaName, int numChainsTX, double transmittedPower, double alfa, double beta, double delta, double transmitterGain, double receptorGain, double workingFrequency, double coverageRadius) {
        ...
        for (int i = 0; i < numChainsTX_; i++) {
            Cell cell = Cell.newInstance(antennaType, antennaName, this.udn_, this, x, y, z, transmittedPower, alfa, beta, delta, transmitterGain, receptorGain, workingFrequency, this.coverageRadius_);
