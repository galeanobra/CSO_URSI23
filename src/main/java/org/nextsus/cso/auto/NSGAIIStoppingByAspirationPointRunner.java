...
public class NSGAIIStoppingByAspirationPointRunner {
  public static void main(String[] args) {
    ...
    String varFileName = "VAR.NSGAII.Const." + nsgaII.getNumberOfEvaluations()+ ".csv" ;
    String funFileName = "FUN.NSGAII.Const." + nsgaII.getNumberOfEvaluations()+ ".csv" ;
